...
* Moved tauchterminal-child from being a submodule to included and managed directly by github in this parent theme
...
= 1.1 =
* Added a child theme for easy customization (see the tauchterminal-child directory)
...
* Changed text domain to "tauchterminal" to match the theme name
