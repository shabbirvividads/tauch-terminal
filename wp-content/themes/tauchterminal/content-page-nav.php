...
$link_pages = wp_link_pages(array(
    ...
    'before'             => '<li>',
    'after'              => '</li>',
    'nextpagelink'         => __('Next page &rarr;', 'tauchterminal'),
    'previouspagelink'     => __('&larr; Previous page', 'tauchterminal'),
    'echo'                => false
));
...
if ($post->ID != $post->post_parent AND +
    ...
    ?>
        ...
        <h1 class="screen-reader-text sr-only"><?php _e('Page navigation', 'tauchterminal'); ?></h1>
        <ul class="pager">
