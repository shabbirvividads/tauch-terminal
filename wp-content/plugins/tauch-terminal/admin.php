...
class TauchTerminal_Admin {
    ...
    public static function admin_menu() {
        ...
        add_submenu_page('tauch-terminal', 'Tauch Terminal', 'Edit Sites', 'manage_options', 'tauch-terminal-edit', array('TauchTerminal_Admin', 'display_editpage') );
    }
    ...
    public static function display_editpage() {
        if ($_POST) {
            TauchTerminal::updateSites($_POST);
        }
        ...
        TauchTerminal::view('edit', array( 'sites' => $sites ));
    }
}
