...
class TauchTerminal_Admin {
    ...
    public static function admin_menu() {
        ...
        add_submenu_page('tauch-terminal', 'Tauch Terminal', 'Edit Sites', 'manage_options', 'tauch-terminal-edit-sites', array('TauchTerminal_Admin', 'display_sites') );
    }
    ...
    public static function display_sites() {
        ...
        switch ($action) {
            case 'add':
                $view = true;
                TauchTerminal::view('edit', array('action' => 'save-new'));
                break;
            case 'save-new':
            ...
            case 'edit':
                ...
                TauchTerminal::view('edit', array('site' => $sites[0], 'action' => 'save-edit'));
                break;
            case 'save-edit':
        ...
        if ($view == false) {
            ...
            TauchTerminal::view('sites_list', array( 'sites' => $sites ));
        }
    }
}
